...
def query_similar_recipes(cur, CS_ids):
	...
	OUTPUT:
		recipes_sql (list): List of lists (row x col) with the following cols:
			"recipesID", "title", "ingredients", "rating", "calories", 
			"sodium", "fat", "protein", "emissions", "prop_ingredients",
			"emissions_log10", "url", "servings", "recipe_rawid", "image_url", 
...
# Check if I can query something exactly:
...
print(search_recipes(cur, 'chicken'))
